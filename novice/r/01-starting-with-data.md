...
> ## Printing with Parentheses {.callout}
>
...
> ## Assigning Values to Variables {.challenge}
>
...
> ## Addressing Columns by Name {.callout}
>
...
> ## Efficient Alternatives {.callout}
>
...
> 
>
> 1.  If the first four characters are selected using the slice `animal[1:4]`, how can we obtain the first four characters in reverse order? {.challenge}
>
> 1.  What is `animal[-1]`?
>    What is `animal[-4]`?
>    Given those answers,
...
> ## Subsetting More Data {.challenge}
>
