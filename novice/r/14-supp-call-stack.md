...
Instead, it creates something called a [stack frame](reference#stack-frame) to keep track of the variables defined by `fahr_to_kelvin`.
...
The big idea here is [encapsulation](reference#encapsulation), and it's the key to writing correct, comprehensible programs.
