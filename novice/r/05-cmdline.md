...
> For a review, see this [lesson](../shell/01-filedir/).
>
...
> ## A Simple Command-Line Program{.challenge}
>
...
>
> 3. Using the function `list.files` introduced in a previous [lesson](03-loops-R/),
...
> ## A Command Line Program with Arguments {.challenge}
>
...
2.  If `action` isn't one of the three recognized flags, the program loads each file but does nothing with it (because none of the branches in the conditional match).
    [Silent failures](reference/#silent-failure) like this are always hard to debug.
...
> ## Parsing Command-Line Flags {.callout}
>
...
> ## Shorter Command Line Arguments {.challenge}
>
...
> ## Implementing `wc` in R {.challenge}
>
